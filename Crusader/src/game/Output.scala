...
object Output {
  ...
  private var tempItemslot1: Texture = null
  private var tempItemslot2: Texture = null
  private var tempItemslot3: Texture = null
  ...
  def startDisplay() {
    ...
    tempItemslot1 = loadTexture("Items/steelSwordG")
    tempItemslot2 = loadTexture("Items/robesG")
    tempItemslot3 = loadTexture("Items/woodenShieldG")
  ...
  def drawSideBar() {
    ...
    font.drawString(width-200, 410, "Items and stuff here", Color.black)
    drawQuadTex(tempItemslot1, width-200, 500, tempItemslot1.getImageWidth, tempItemslot1.getImageHeight)
    drawQuadTex(tempItemslot2, width-150, 500, tempItemslot2.getImageWidth, tempItemslot2.getImageHeight)
    drawQuadTex(tempItemslot3, width-100, 500, tempItemslot3.getImageWidth, tempItemslot3.getImageHeight)
  }
